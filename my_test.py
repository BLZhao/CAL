...
def main():
    ...
    train_set = torch.load(save_path + "/ATSD_v0_train_dataset_cor0.5.pt", weights_only=False)
    val_set = torch.load(save_path + "/ATSD_v0_val_dataset_cor0.5.pt", weights_only=False)
